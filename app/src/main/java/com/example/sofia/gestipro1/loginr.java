...
public class loginr extends AppCompatActivity implements View.OnClickListener{
    ...
    public String enviardatosGET(String usu, String pas) {
        ...
        try {
            url= new URL("http://192.168.1.13/webservice/lir.php?usu="+usu+"&pas="+pas);
 ...
 public void gpreferencias(){
    ...
    public String ed(String usu) {
        ...
        StringBuilder result = null;
        try {
            url= new URL("http://192.168.1.13/webservice/cpkr.php?usu="+usu);
            HttpURLConnection connection=(HttpURLConnection)url.openConnection();
            respuesta=connection.getResponseCode();
